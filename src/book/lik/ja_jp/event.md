...
EVENT.Item = {
    ...
    Be = {
        --- 攻撃される
        ---@alias noteOnItemBeAttackData noteOnItemBase|{sourceUnit:Unit,damage:"ダメージ値"}
...
EVENT.Destructable = {
    --- 破壊可能なものは死ぬ
    ---@alias noteOnDestructableDeadData noteOnDestructableBase|{name:"信頼できない名前",x:"座標X",y:"座標Y"}
