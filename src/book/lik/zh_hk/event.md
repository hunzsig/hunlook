...
EVENT.Unit = {
    ...
    --- 附魔反應
    ---@alias noteOnUnitEnchantData noteOnUnitBase|{sourceUnit:Unit,enchantType:"附魔類型",percent:"加成百分比"}
    Enchant = "unitEnchant",
    --- 攻擊吸血
    ...
    --- 免疫[附魔]
    ---@alias noteOnUnitImmuneEnchantData noteOnUnitBase|{sourceUnit:Unit,enchantType:"附魔類型"}
