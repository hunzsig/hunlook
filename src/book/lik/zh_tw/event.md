...
---@alias noteOnTimerDestructData {triggerObject:Timer} 計時器
EVENT.Object = {
    --- 物件建立
...
EVENT.Unit = {
    ...
    --- 造成傷害
    ---@alias noteOnUnitDamageData noteOnUnitBase|{targetUnit:Unit,damage:"傷害值",damageSrc:"傷害來源",damageType:"傷害型別"}
    Damage = "unitDamage",
    --- 單位出生
    ...
    --- 單位受傷
    ---@alias noteOnUnitHurtData noteOnUnitBase|{sourceUnit:Unit,targetUnit:Unit,damage:"傷害值",damageSrc:"傷害來源",damageType:"傷害型別"}
    Hurt = "unitHurt",
    --- 單位受傷前
    ...
    Be = {
        ...
        Avoid = "be:unitAvoid",
        --- 被破防
        ---@alias noteOnUnitBeBreakArmorData noteOnUnitBase|{sourceUnit:Unit,breakType:"無視型別"}
...
EVENT.Frame = {
    ...
    --- 左鍵釋放
    ---@alias noteOnFrameLeftReleaseData noteOnFrameBase|{triggerPlayer:Player,status:"滑鼠是否還在Frame內"}
    ...
    --- 右鍵釋放
    ---@alias noteOnFrameRightReleaseData noteOnFrameBase|{triggerPlayer:Player,status:"滑鼠是否還在Frame內"}
