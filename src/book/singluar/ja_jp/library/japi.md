...
###### 詳細呼び出し自己表示 /vendor/kernel/library/foundation/japi.lua

> 方法：JAPI環境、フレームイン環境と密接に関連し、勝手に変更しない
...
japi.DzAPI_Map_GetLastRecommendTime(whichPlayer)
japi.DzAPI_Map_GetLotteryUsedCount(whichPlayer)
japi.DzAPI_Map_GameResult_CommitData(whichPlayer, key, value)
